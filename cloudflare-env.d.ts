/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: be71e8ab6f8a6645e27eb424481a97af)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	FILES: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	OPENROUTER_MODEL_PAGE_EXTRACTION: "google/gemini-2.5-flash";
	OPENROUTER_MODEL_RECONCILIATION: "google/gemini-2.5-flash";
	OPENROUTER_MODEL_GENERATION: "google/gemini-2.5-flash";
	OPENROUTER_MODEL_CLEANUP: "google/gemini-2.5-flash";
	OPENROUTER_APP_NAME: "fileDrop";
	ENABLE_VISION_EXTRACTION: "false";
	MAX_VISION_PAGES_PER_RUN: "3";
	ENABLE_AI_CLEANUP: "true";
	MAX_AI_CLEANUP_QUESTIONS_PER_RUN: "20";
	MAX_AI_TEXT_CHARS: "60000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_MODEL_PAGE_EXTRACTION" | "OPENROUTER_MODEL_RECONCILIATION" | "OPENROUTER_MODEL_GENERATION" | "OPENROUTER_MODEL_CLEANUP" | "OPENROUTER_APP_NAME" | "ENABLE_VISION_EXTRACTION" | "MAX_VISION_PAGES_PER_RUN" | "ENABLE_AI_CLEANUP" | "MAX_AI_CLEANUP_QUESTIONS_PER_RUN" | "MAX_AI_TEXT_CHARS" | "REQUIRE_API_KEY">> {}
}
